...
<div class="g"><div class="g-head"><span class="term">DL reduction bound</span><span class="anchor">Forking.Algebraic.ComputedAlgebraicFSFamily.binding_prob_le_of_generatorRO_textbookDL</span></div><div class="def">The random-slot accounting instantiated with the computed algebraic Fiat–Shamir producer. In the uniform generator-RO setup model, the real binding probability is bounded by the recursive query loss, the <code>z = 0</code> slice, and <code>|basis|</code> times the textbook-DL advantage.</div></div>
</section>
...
<div class="g"><div class="g-head"><span class="term">capstones</span><span class="anchor">Soundness/Vesta.lean · Forking/Algebraic.lean</span></div><div class="def">The <code>orchard_verifier_vesta_*</code> ladder exposes legacy opening and constraint forms across conditional, reduction, forking, deployed, adaptive, and rewind models. The computed algebraic Fiat–Shamir endpoint carries representations through the adaptive adversary, recursively constructs PR #28’s deployed instance, and bounds the real binding event by extraction loss plus plain DL.</div></div>
